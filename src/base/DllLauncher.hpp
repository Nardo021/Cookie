...
{
public:
	auto OnDllAttach( HINSTANCE hInstace ) -> void;
	auto OnDestroy() -> void;
	auto ApplyBootstrapParam( LPVOID lpParameter ) -> void;
	auto RunBootstrap() -> DWORD;
...
private:
	char m_DllPathRaw[MAX_PATH] = { 0 };
	char m_CS2PathRaw[MAX_PATH] = { 0 };

...
class CCookieGUI final : public ICookieGUI
{
public:
...
private:
	...
	enum EGuiStyle_t : uint32_t
	{
		GUI_STYLE_INDIGO,
		GUI_STYLE_VERMILLION,
		GUI_STYLE_CLASSIC_STEAM,
	};
...
public:
	...
	bool m_needRecreateDeviceObjects = false;
...
private:
	...
	{
		enum class FontBuildMode { Default };
		FontBuildMode BuildMode = FontBuildMode::Default;

...
bool combo(std::string_view label, int* current_item, const std::vector<std::string>& items, int popup_max_height_in_items, int max_count)
{
    ImGuiContext& g = *GImGui;
...
bool c_widget::dropdown(std::string_view label, int* current_item, const std::vector<std::string>& items, int max_count)
{
    const bool value_changed{ combo(label, current_item, items, -1, max_count) };
    return value_changed;
}

void c_widget::multi_dropdown(std::string_view label, bool variable[], const std::vector<std::string>& labels, int max_count)
{
    ImGuiContext& g{ *GImGui };
...
bool tool_combo(std::string_view label, int* current_item, const std::vector<std::string>& items, int popup_max_height_in_items, int max_count)
{
    ImGuiContext& g = *GImGui;
...
bool c_widget::tool_dropdown(std::string_view label, int* current_item, const std::vector<std::string>& items, int max_count)
{
